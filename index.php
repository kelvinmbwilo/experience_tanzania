...
<header class="header">
<h1 class="seo">Welcome to Experience Tanzania  a complete <span class="blink"> complete </span> and <span class="blink"> Satisfying </span> Experience.</h1>
...
<div class="footerMenu">
    <a href="register.php"><i class="icon-home"></i> HOME</a> | 
	<a href="about_us.php"> ABOUT US</a> | 
	<a  href="topology.php" >TOPOLOGY</a> | 
	<a href="contact_us.php">CONTACTS </a>
<p class="pull-right"><a href="#">Terms and condition </a> &copy; Copyright 2013 Experience Tanzania Ltd. </p>
</div>
</div>
</footer>
